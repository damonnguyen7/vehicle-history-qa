<template>
  <svg class="vh-logo" width="132" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 148 28" xml:space="preserve" role="presentation" fill="#FFFFFF"><path d="M7.6,4.5c2.7,4.8,5.3,9.6,8,14.5l0.8-1.4h4.9l-4.8,8.7l-0.9,1.6L0.2,0h11.9L9.6,4.5H7.6z M15.8,0h2.1l-2.5,4.5
